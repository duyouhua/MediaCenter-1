...
public class PreparedResource {
    ...
    private HashMap<String, String> catchImageVideoType = new HashMap<String,String>();
    ...
    public PreparedResource(Context context){
        ...
        fileType.put(FILE_TYPE_DISK, R.drawable.usb_disk);
    ...
    private void loadDefaultMineType(){
    	...
    	catchImageVideoType.put("avi", "video/*");
    	catchImageVideoType.put("mp4", "video/*");
    	catchImageVideoType.put("3gp", "video/*");
    ...
    public boolean canCatchImageVideoType(String key){
    	if(catchImageVideoType.containsKey(key)){
    		return true;
    	}
    	return false;
    }
